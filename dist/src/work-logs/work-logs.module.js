...
const work_photos_controller_1 = require("./work-photos.controller");
...
exports.WorkLogsModule = WorkLogsModule = __decorate([
    (0, common_1.Module)({
        providers: [work_logs_service_1.WorkLogsService],
        controllers: [work_logs_controller_1.WorkLogsController, work_photos_controller_1.WorkPhotosController],
    })
], WorkLogsModule);
